...
if __name__ == '__main__':
    ...
    parser.add_argument('--common_results_csv', type=str, required=True, help="The CSV with the results required by the clinician for the analysis of the heatmaps.")
    ...
    # Load common results CSV
    common_results_df = pd.read_csv(args.common_results_csv)
    ...
    for fold in range(n_folds):
        ...
        for row_idx, row in csv_data_df.iterrows():
            ...
            if slide_id in list(common_results_df['wsi'].values):
                ...
                if y_pred == label:
                    ...
                    study_data_dict = {
                        'high':{'attention_scores':h_attention_scores, 'indices':h_indices, 'directory':'high', 'coords':h_coords},
                        'low':{'attention_scores':l_attention_scores, 'indices':l_indices, 'directory':'low', 'coords':l_coords}
                    }
